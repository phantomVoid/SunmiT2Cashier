        ...
        for (int i : GoodsCode.MODE) {
            ...
            switch (i) {
                case GoodsCode.MODE_0:
                    if (!isZh()) {
                        list = new ArrayList<>();
                        GvBeans beans1 = new GvBeans(R.drawable.goods_english_1, "Monster", getString(R.string.units_money_units) + "1.99", "6954767417684", 10000, getString(R.string.units_tin), 0);
                        GvBeans beans2 = new GvBeans(R.drawable.goods_english_2, "RedBull", getString(R.string.units_money_units) + "2.99", "6954767430362", 10000, getString(R.string.units_tin), 0);
                        GvBeans beans3 = new GvBeans(R.drawable.goods_english_3, "Coca", getString(R.string.units_money_units) + "1.99", "4891028164456", 10000, getString(R.string.units_tin), 0);
                        GvBeans beans4 = new GvBeans(R.drawable.goods_english_4, "Innocent Juice", getString(R.string.units_money_units) + "4.99", "6905069998814", 10000, getString(R.string.units_tin), 0);
                        GvBeans beans5 = new GvBeans(R.drawable.goods_english_5, "Tropicana Juice", getString(R.string.units_money_units) + "4.99", "6920584471017", 10000, getString(R.string.units_tin), 0);
                        GvBeans beans6 = new GvBeans(R.drawable.goods_english_6, "Milk", getString(R.string.units_money_units) + "4.99", "6954767417684", 10000, getString(R.string.units_tin), 0);
                        list.add(beans1);
                        list.add(beans2);
                        list.add(beans3);
                        list.add(beans4);
...
//            drinkAdapter.setNewData(list);
    ...
    private void initData() {
        ...
        soundPool.load(MainActivity.this, isZh() ? R.raw.alipay : R.raw.alipay_en, 1);// 2
    }
        ...
        if (isK1) {
            ...
            ThreadPoolManager.getsInstance().execute(() -> {
                ...
                for (Device device : deviceList) {
                    ...
                    printerPresenter.printByDeviceManager(goods_data, payMode, device);
                }
            });
    ...
    private void addGoodsByScale(String total, GvBeans gvBeans) {
        ...
        float price = 0.00f;
        for (MenusBean bean1 : menus) {
            price = new BigDecimal(price).add(new BigDecimal(bean1.getMoney().substring(1))).floatValue();
        }
        tvPrice.setText(ResourcesUtils.getString(MainActivity.this, R.string.units_money_units) + decimalFormat.format(price));
        menusAdapter.update(menus);
        buildMenuJson(menus, decimalFormat.format(price));
