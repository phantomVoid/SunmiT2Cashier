...
import com.sunmi.sunmit2demo.bean.SunmiLink;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    if (payMode == PayDialog.PAY_MODE_0) {
                        try {
...
//                    wifi = "{\"type\":\"password\",\"data\":{\"ssid\":\"无线牛逼\",\"password\":\"12345678\",\"qrcode\":\"\",\"expires_in\":0}}";
    ...
    private void printGoodsByDeviceManager(MenuBean menuBean) {
        ...
        mManager.addFeedDots(10);
        mManager.addTextLeftRight(real, ResourcesUtils.getString(context, R.string.units_money_units) + PayDialog.PayMoney);
    }
